...
declare namespace osAccount {
  ...
  interface AccountManager {
     ...
     * @since 12
     */
    createOsAccountForDomain(type: OsAccountType, domainInfo: DomainAccountInfo,
      options?: CreateOsAccountForDomainOptions): Promise<OsAccountInfo>;
  ...
  class UserAuth {
     ...
     * @throws { BusinessError } 12300022 - Device hardware abnormal.
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
     * @since 8
     */
     ...
     * @throws { BusinessError } 12300020 - Cross-device communication failed.
     * @throws { BusinessError } 12300021 - Cross-device capability not supported.
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
     * @since 12
     */
  ...
  enum AuthIntent {
    ...
    /**
     * Indicates the intent of abandoned PIN authentication.
     *
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi
     * @since 20
  ...
  interface AuthResult {
    ...
    /**
     * Indicates the description for auth result.
     *
     * @type { ?string }
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
  ...
  interface EnrolledCredInfo {
    ...
    /**
     * Indicates the credential is abandoned.
     *
     * @type { ?boolean }
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
    ...
    /**
     * Indicates the credential remained validity period.
     *
     * @type { ?number }
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
  ...
  enum GetPropertyType {
    ...
    /**
     * Indicates the length of credential.
     *
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
     * @since 20
  ...
  enum SetPropertyType {
    ...
    /**
     * Indicates reset lockout duration.
     *
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
     * @since 20
     */
    RESET_LOCKOUT_DURATION = 2,
  }
  ...
  enum AuthType {
    ...
    /**
     * Indicates the TOKEN_DEVICE authentication type.
     *
     * @syscap SystemCapability.Account.OsAccount
     * @systemapi Hide this for inner system use.
     * @since 20
