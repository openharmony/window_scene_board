...
import { GridItemPositionUtil } from '../../../common/utils/GridItemPositionUtil';
...
export class SingleItemSqueezeEngine extends Engine {
  ...
  private computeSingleItemSqueeze(x: number, y: number, isZSqueeze: boolean): void {
    ...
    let isSqueezeBackwards: boolean = this.isSqueezeBackwards(x, y, isZSqueeze, nearestPosition);
