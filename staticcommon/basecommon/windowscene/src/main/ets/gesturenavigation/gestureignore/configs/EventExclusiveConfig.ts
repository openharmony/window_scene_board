...
export enum EventExclusiveBitMap {
  ...
  EventType.GESTURE_STATUS_BAR | EventType.GLOBALSEARCH | EventType.FORMSTACK_GESTURE | EventType.AIBAR_DRAG,
  //底部导航
  ...
  EventType.AIBAR_DRAG | EventType.THREE_FINGER_GESTURE,
  //状态栏下拉
  ...
  // AiBar点击返回
  AI_BAR_CLICK_BACK = EventType.NO_EXCLUSIVE,
  // pc应用在手机上提示蒙版
...
export class EventExclusiveConfig {
  private static eventExclusiveInfoMap: Map<EventType, [string, EventExclusiveBitMap]> = new Map([
    ...
    [EventType.AIBAR_DRAG, ['AIBAR_DRAG', EventExclusiveBitMap.NO_EXCLUSIVE]],
    ...
    [EventType.AI_BAR_CLICK_BACK, ['AI_BAR_CLICK_BACK', EventExclusiveBitMap.AI_BAR_CLICK_BACK]],
  ...
  private static eventTypeInfoMap: Map<string, EventType> = new Map([
    ...
    ['AIBAR_DRAG', EventType.AIBAR_DRAG],
    ...
    ['AI_BAR_CLICK_BACK', EventType.AI_BAR_CLICK_BACK],
