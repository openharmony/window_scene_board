...
declare namespace statusBar {
  ...
  interface StatusBarItem {
    ...
    /**
     * Information displayed on icon hover.
     *
     * @type { ?string }
     * @syscap SystemCapability.PCService.StatusBarManager
     * @since 6.0.2(22)
  ...
  /**
   * read hoverTips from parcel. This method is only for 2in1 or pc.
   *
   * @param { rpc.MessageSequence } data - The rpc remote request data.
   * @returns { string } The instanceKey of calling app.
   */
  function readHoverTipsToParcel(data: rpc.MessageSequence): string;
  ...
  /**
   * write hoverTips to parcel. This method is only for 2in1 or pc.
   *
   * @param { StatusBarItem } icons - The StatusBar Icon.
   * @param { rpc.MessageSequence } data - The rpc remote request data.
   */
  function writeHoverTipsToParcel(hoverTips: string, data: rpc.MessageSequence): void;
