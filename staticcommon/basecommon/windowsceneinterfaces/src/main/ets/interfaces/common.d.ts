...
declare enum EffectType {
  /**
   * Defines use the effects template defined by the parent effectComponent.
   *
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @atomicservice
   * @since 14
  ...
  /**
   * Defines use the effects template defined by the window.
   *
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @atomicservice
   * @since 14
...
declare interface ContextMenuOptions {
  ...
  /**
   * layout margin for preview snapshot
   */
  ...
  /**
   * Defines the border radius of preview.
   *
...
declare class CommonMethod<T> {
   ...
   * @since 18
   */
  backgroundBlurStyle(value: BlurStyle, options?: BackgroundBlurStyleOptions, sysOptions?: SystemAdaptiveOptions): T;
   ...
   * @since 18
   */
  backgroundEffect(options: BackgroundEffectOptions, sysOptions?: SystemAdaptiveOptions): T;
   ...
   * @since 18
   */
  foregroundBlurStyle(value: BlurStyle, options?: ForegroundBlurStyleOptions, sysOptions?: SystemAdaptiveOptions): T;
 ...
 focusScopePriority(scopeId: string, priority?: FocusPriority): T;
   ...
   * @since 18
   */
  blur(value: number, options?: BlurOptions, sysOptions?: SystemAdaptiveOptions): T;
  ...
  useEffect(value: boolean, effectType?: EffectType): T;
   ...
   * @since 18
   */
  backdropBlur(value: number, options?: BlurOptions, sysOptions?: SystemAdaptiveOptions): T;
  ...
  */
   ...
   * @param { boolean } [isOutOfBoundsAllowed] - the flag to allow the child components can exceed the parent's boundary or not.
   * @returns { T }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @crossplatform
   * @atomicservice
   * @since 21
   */
  onVisibleAreaChange(ratios: Array<number>, event: VisibleAreaChangeCallback, isOutOfBoundsAllowed?: boolean): T;
  ...
  accessibilityScrollTriggerable(scrollable: boolean): T;
  ...
  backgroundBrightnessInternal(params: BrightnessOptions): T;

  foregroundBrightness(params: BrightnessOptions): T;
...
declare interface BrightnessOptions {
 ...
 *
 * @typedef { function } AccessibilityTransparentCallback1
