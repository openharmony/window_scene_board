...
const TAG = 'AiBarCloneCallbackManager';
const log: LogHelper = LogHelper.getLogHelper(LogDomain.HOME, TAG);

/**
 *  settingData克隆完成事件回调
 */
export class AiBarCloneCallbackManager {
  ...
  private static _instance: AiBarCloneCallbackManager | null = null;

  public static getInstance(): AiBarCloneCallbackManager {
    if (!AiBarCloneCallbackManager._instance) {
      AiBarCloneCallbackManager._instance = new AiBarCloneCallbackManager();
    }
    return AiBarCloneCallbackManager._instance;
  }
