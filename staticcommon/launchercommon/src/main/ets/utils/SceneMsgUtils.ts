...
export enum SceneMsgEnum {
  ...
  // 语音助手卡片更新ID
  SCENE_MSG_AI_SUGGESTION_UPDATE_FORM_ID = '100019|SCENE_MSG_AI_SUGGESTION_UPDATE_FORM_ID',
  // 获取语音助手卡片失败
  SCENE_MSG_AI_SUGGESTION_ACQUIRE_DEFAULT_CARD_ERROR = '100020|SCENE_MSG_AI_SUGGESTION_ACQUIRE_DEFAULT_CARD_ERROR',
  // 文件夹数据更新
  ...
  // 语音助手卡片移除事件
  SCENE_MSG_AI_SUGGESTION_ITEM_DROP_EVENT = '100036|SCENE_MSG_AI_SUGGESTION_ITEM_DROP_EVENT',
  // 文件夹内删除菜单点击
  ...
  RDB_UPDATE_VOICE_CARD_INFO_MAP = '200006|RDB_UPDATE_VOICE_CARD_INFO_MAP',
  ...
  RDB_DELETE_VOICE_CARD_INFO_BY_CARD_ID = '200051|RDB_DELETE_VOICE_CARD_INFO_BY_CARD_ID',
