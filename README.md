...
3. 产品层
  - 以 `product` 为主，当前支持 `phone`、`pad`、`pc` 三种产品。
...
5. `phone`、`pad`、`pc` 作为最终集成层，通过 `ServiceExtensionAbility` 启动 SceneBoard，接入基础屏幕实现。
